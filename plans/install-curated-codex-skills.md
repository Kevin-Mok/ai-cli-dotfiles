...
- [x] Update `README.md` where it currently describes `dot_agents/skills/` as only containing `pd`.
...
- Reworked `README.md` so it no longer frames `dot_agents` as a single-skill `pd` folder and instead documents the broader local skill library.
...
- Verification completed with:
  - `rg -n 'Why This Improves Agentic Engineering|dot_agents/skills/pd/SKILL.md|playwright|gh-fix-ci|openai-docs|transcribe|agentic engineering' /home/kevin/linux-config/README.md`
