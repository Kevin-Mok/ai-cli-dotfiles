...
- **[`dot_agents/skills/`][skills-dir]:** the reusable workflow layer for higher-level jobs like CI repair, browser automation, screenshots, docs lookup, PDF work, image generation, transcription, and commit planning.
